...
router.openapi(
  createRoute({
    ...
    description:
      ...
      'decision model (TypeSafe Jev, either directly via `provider: "typesafe"` or through the Vercel AI Gateway via ' +
      '`provider: "aigateway"`) and returns structured answers. `choice` returns the selected option with a full ' +
